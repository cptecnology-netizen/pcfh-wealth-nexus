      ...
      >
        ...
        <div className="p-4 border-t border-slate-700">
          <div className="flex items-center gap-3">
            <img src={MOCK_FAMILY[0].avatar} alt="User" className="w-10 h-10 rounded-full border-2 border-pcfh-gold" />
            {sidebarOpen && (
              <div className="flex-1 min-w-0">
                <p className="text-sm font-medium text-white truncate">{MOCK_FAMILY[0].name}</p>
                <p className="text-xs text-slate-400 truncate">{MOCK_FAMILY[0].role}</p>
              </div>
            )}
